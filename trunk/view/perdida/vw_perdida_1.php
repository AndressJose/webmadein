...
<section>
  <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Inventario►Perdidas</h1> 
</section>
<section><center>
    <fieldset>
      <legend>Perdidas</legend>
        <form method="POST">
            ...
            <input type="text" name="txt_nombre" value="" class="required"/>*<br>
            <div class="demo">
              <label>Fecha</label>>
              <input type="date" id="datepicker" name="txt_fecha" value="<?php echo date("Y-m-d"); ?>" class="required"/>*<br>
            </div>
            <label>Cantidad</>
            <input type="text" name="txt_cantidad" value="" class="required"/>*<br>
