...
<section>
    <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►<a href="javascript:Enviar('../../control/Usuario/crtl_Usuini.php','content')">Usuarios</a>►Modificar Usuario</h1> 
</section>
<section><center>

        <form id="form" method="POST" action="../../control/ctrl_Usuario.php">
...
<input type="text" name="txt_apellido" class="required"/>*
</p>
<p>
<label for="txt_login">Login:</label>
<input type="text" name="txt_login" class="required"/>*
</p>
<p>
...
<input type="email" name="txt_email" class="required email" />*
</p>
<p>
...
<input type="text" name="txt_telefono" class="required number"/>*
</p>
<p>
<input type="submit" value="Modificar" name="registrar"  />
</p>
</fieldset>
</div>     
