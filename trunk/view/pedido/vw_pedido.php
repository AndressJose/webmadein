...
<html lang="es">
	<head>
		...
		<link type="text/css" href="../../view/css/menu.css" rel="stylesheet" />
                ...
                <link type="text/css" href="jquery-ui-1.8.4.custom.css" rel="stylesheet" />                <script type="text/javascript" src="../../view/js/jquery.ui.core.js"></script>
...
<section>
    <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Inventario►Pedido</h1>
</section>        
<section><center>       
    <form name="FrmPedido" method="POST" action="">
        
    <label>Nombre Pedido</label>
    <input type="text" name="NombrePedido" value="<?php echo $value[1]; ?>" class="required"/>*<br>

    <label>Cantidad Pedido</label>
    <input type="text" name="CantidadPedido" value="<?php echo $value[2]; ?>" class="required number"/>*<br>
    <div class="demo">
        <label>Fecha Pedido</label>
        <input type="text" id="datepicker" value="<?php echo date("Y-m-d"); ?>" class="required" name="FechaPedido" />*<br>
    </div>
    <input type="submit" value="Registrar" name="BtnRegistrar" />
    <input type="submit" value="Actualizar" name="BtnActualizar" /><br><br><br><br>

    <label>Codigo Consultar</label>
    <input type="text" name="CodigoConsultar" value="" /><br>
    <input type="submit" value="Consultar" name="BtnConsultar" />
    <input type="submit" value="Listar" name="BtnListar" />
   
</form>

    <form name="FrmMsj" method="POST">
        <?php
            echo $msj;
