...
<section>
    <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Inventario►Devolucion</h1>    
</section>    
<section><center>   
  <fieldset>
  ...
  <form method="Post" action="">
        ...
        <input type="text" name="txt_nom_pro" value="<?php echo $value[1]; ?>" class="required" />*<br>
        <div class="demo">
          <label>Fecha Venta</label>
          <input type="text" id="datepicker" value="<?php echo date("Y-m-d"); ?>" nname="txt_fecha" class="required"/>*
        </div>
        <label>Nombre del cliente</label>
        <input type="text" name="txt_nom_cliente" value="<?php echo $value[3]; ?>" class="required"/>*<br>
        <labe>Descripcion</label>
        <input type="text" name="txt_descripcion" value="<?php echo $value[4]; ?>" class="required"/>*<br>
        <input type="submit" value="Registrar" name="btn_registrar" /> 
        <input type="submit" value="Listar" name="btn_listar" />
        <input type="submit" value="Modificar" name="btn_modificar" />
        <input type="hidden" name="txt_id" value="<?php echo $codigo; ?>">
    </form>
    <form method="POST">
        <?php echo $msn; ?>
    </form>
