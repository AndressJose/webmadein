...
<section>
  <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Inventario►<a href="javascript:Enviar('../../control/Producto/ctrl_Product.php','content')">Producto</a>►Listar Productos</h1>
</section>
<section><center>  
        <form id="form" method="POST" action="../../../../control/Producto/ctrl_listarproductos.php">
<div id="cuerpo">   
    <script languague="javascript">
      $(document).ready(function(){
      $("#form").validate();
