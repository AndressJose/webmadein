...
<section>
 <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Inventario►<a href="javascript:Enviar('../../control/Producto/ctrl_Product.php','content')">Producto</a>►Desactivar Productos</h1> 
</section> 
<section><center>
        <form id="form" method="POST" action="../../../../control/Producto/ctrl_EliProduct.php">
...
<p>
<input type="submit" value="Eliminar" name="cosultar"  />
</p>
</fieldset>
</div>     
