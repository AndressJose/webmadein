              ...
              <section id="login">
                    ...
                    <section id="toolbar">
                            <section id="rigth">
                                    ...
                                    <section id="help">
                                        <a  href="'../../view/principal/vw_Ayuda.php','content')">ayuda</a>
                                    </section>
                            </section>
                    </section>
                    <section id="cabeza">
...
<section>
  <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Administrar►Proveedor►Modificar Proveedor</h1> 
</section>
<section><center>
<fieldset>
  <legend>Proveedor</legend>
<form name="registrar" method="POST" align="center">
   <label>Marca del producto</label><br>
   <select name="txt_mar_prove">
     <?php 
     echo $combomar;
     ?>
   </select><br>  
    <label>Nombre de la empresa</label><br>
    <input type="text" name="txt_nom_empre" value="<?php echo $value[2]?>" class="required"/>*<br>
    <label>Nombre del contacto</label><br>
    <input type="text" name="txt_nom_cont" value="<?php echo $value[3]?>" class="required"/>*<br>
    <label>Telefono</label><br>
    <input type="text" name="txt_tel_prove" value="<?php echo $value[4]?>" class="required"/>*<br>
    <label>Email</label><br>
    <input type="text" name="txt_email_prove" value="<?php echo $value[5]?>"  class="required"/>*<br>
    <input type="submit" value="Modificar" name="btn_modificar" /><br>
</form>
