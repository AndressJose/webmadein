...
<section>
 <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Inventario►<a href="javascript:Enviar('../../control/Producto/ctrl_Product.php','content')">Producto</a>►Consultar Productos</h1> 
</section> 
<script languague="javascript">
$(document).ready(function(){
$("#form").validate();
...
<section><center>
        <form id="form" method="POST" action="../../../../control/Producto/ctrl_consulpro.php">
<div id="cuerpo"> 
