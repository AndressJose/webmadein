...
<section>
    <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Catalogo</h1> 
 <section>
              <center>            
                <h1 style=" font-family: serif ,cursive,fantasy; font-size:40px;font-weight:bold;">¡Catálogo!</h1>
                <p style=" font-family: serif ,cursive,fantasy; font-size:20px;font-weight:bold; text-align: center;">
                    Aqui se muestran los productos que ofrecemos
              </center>
            </section>
</section> 
<footer>
