...
<section>
    <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Catalogo de Servicios</h1>
</section>        
<section><center>            
<form name="form" method="POST" action="">
<h1 style=" font-family: serif ,cursive,fantasy; font-size:40px;font-weight:bold;">Servicios de  Manantial De Innovaciones </h1>
<p style=" font-family: serif ,cursive,fantasy; font-size:25px;font-weight:bold; text-align: center;">
Lista de Servicio
<li style=" font-family: serif ,cursive,fantasy; font-size:20px;font-weight:bold; text-align: center;">Maniqure</li>   
<img src="../../view/img/manicure.jpg" width="450">
<li style=" font-family: serif ,cursive,fantasy; font-size:20px;font-weight:bold; text-align: center">Pedicure</li> 
<img src="../../view/img/pedicure.jpg" width="450">
<li style=" font-family: serif ,cursive,fantasy; font-size:20px;font-weight:bold; text-align: center">Peniados</li>
<img src="../../view/img/peinados.jpg" />
</form>
</center>
</section>
<footer>
