...
<section><center>   
  ...
  <form method="Post" action="">
        ...
        <input type="text" name="txt_nom_pro" value="" class="required" />*<br>
        <div class="demo">
          <label>Fecha Venta</label>
          <input type="text" id="datepicker" value="" name="txt_fecha" class="required"/>*
        </div>
        <label>Nombre del cliente</label>
        <input type="text" name="txt_nom_cliente" value="" class="required"/>*<br>
        <labe>Descripcion</label>
        <input type="text" name="txt_descripcion" value="" class="required"/>*<br>
