...
<section>
  <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Inventario►<a href="javascript:Enviar('../../control/Producto/ctrl_Product.php','content')">Producto</a>►Modificar Productos</h1>
</section>
<form method="post" action="../../../../control/Producto/ctrl_modificarproducto.php">
    <center>
        <label for="txt_nombre">Nombre</label>
        <input type="text" name="txt_nombre" id="txt_nombre" value="<?php echo $nombre; ?>" class="required">*
        <input type="submit" name="btn_buscar" value="Buscar" onclick="">
        <br>
        <label for="txt_cantidad">Cantidad</label>
        <input type="number" name="txt_cantidad" id="txt_cantidad" value="<?php echo $cantidad; ?>" class="required number">*
        <br>
        <label for="txt_precio">Precio entrada</label>
        <input type="text" name="txt_precioentrada" id="txt_precioentrada" value="<?php echo $precioentrada; ?>" class="required number">* 
        <br>
        <label for="txt_precio">Precio salida</label>
        <input type="text" name="txt_preciosalida" id="txt_preciosalida" value="<?php echo $preciosalida; ?>" class="required number">*
        <br>
        <label for="cbo_tipo">Tipo de producto</label>
