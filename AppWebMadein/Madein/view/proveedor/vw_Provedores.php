...
<section>
    <h1><a href="../../control/inicio/ctrl_inicio.php">Inicio</a>►Administrar►Proveedor►Agregar proveedor</h1> 
</section>
<section><center>
<fieldset>
...
<form name="registrar" method="POST" align="center">
   ...
   <select name="txt_mar_prove">
     <option value="1">Yambal</option>
     <option value="2">Esika</option>
     <option value="3">Vesuan</option>
   </select><br>  
    <label>Nombre de la empresa</label><br>
    <input type="text" name="txt_nom_empre" class="required"/>*<br>
    <label>Nombre del contacto</label><br>
    <input type="text" name="txt_nom_cont" class="required"/>*<br>
    <label>Telefono</label><br>
    <input type="text" name="txt_tel_prove" class="required"/>*<br>
    <label>Email</label><br>
    <input type="text" name="txt_email_prove"  class="required"/>*<br>
    <input type="submit" value="Registrar" name="btn_resgistrar" />
